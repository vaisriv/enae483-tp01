...
% Assigned LOX_RP1 as Stage 1 Propellant
disp("running huy's code");

%% LOX_LCH4
LOX_RP1.LOX_LCH4 = TwoStageLV(propellants.LOX_RP1, propellants.LOX_LCH4);
...
%% LOX_LH2
LOX_RP1.LOX_LH2 = TwoStageLV(propellants.LOX_RP1, propellants.LOX_LH2);
...
%% LOX_RP1
LOX_RP1.Solid = TwoStageLV(propellants.LOX_RP1, propellants.Solid);
...
%% Storables
LOX_RP1.Storables = TwoStageLV(propellants.LOX_RP1, propellants.Storables);
