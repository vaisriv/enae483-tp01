...
% Assigned LOX_LCH4 as Stage 1 Propellant
...
%% LOX_LH2
LOX_LCH4.LOX_LH2 = TwoStageLV(propellants.LOX_LCH4, propellants.LOX_LH2);
...
%% LOX_RP1
LOX_LCH4.LOX_RP1 = TwoStageLV(propellants.LOX_LCH4, propellants.LOX_RP1);
...
%% LOX_LCH4
LOX_LCH4.Solid = TwoStageLV(propellants.LOX_LCH4, propellants.Solid);
...
%% Storables
LOX_LCH4.Storables = TwoStageLV(propellants.LOX_LCH4, propellants.Storables);
